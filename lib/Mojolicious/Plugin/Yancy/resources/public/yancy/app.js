    ...
    methods: {
        ...
        parseSpec: function ( spec ) {
            var pathParts = [],
                ...
                collectionName, collection, pathObj, firstCollection;
            this.collections = {};
            ...
            for ( var schemaKey in schemas ) {
                ...
                for ( var propKey in schema.properties ) {
                    ...
                    if ( prop[ 'x-html-field' ] ) {
                        schema.properties[ prop['x-html-field' ] ][ 'x-hidden' ] = true;
                    }
                }
            }
            ...
            for ( var pathKey in spec.paths ) {
                ...
                if ( schemas[ collectionName + 'Item' ]['x-hidden'] ) {
                    continue;
                }
                ...
                if ( pathParts.length == 2 ) {
                    if ( pathObj.get ) {
                        collection.operations["list"] = {
                            ...
                            schema: schemas[ collectionName + 'Item' ]
                        };
                    }
                    if ( pathObj.post ) {
