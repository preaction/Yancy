...
$t->app->yancy->file->cleanup;
ok !-e $root->child( @avatar_digest_path, 'avatar.jpg' ), 'unlinked file is removed';
ok -e $root->child( @avatar_digest_path, 'avatar.jpg' ), 'linked file still exists';
...
subtest 'test default file plugin' => sub {
    ...
    is $app->yancy->file->path, $app->home->child( 'public/uploads' ),
